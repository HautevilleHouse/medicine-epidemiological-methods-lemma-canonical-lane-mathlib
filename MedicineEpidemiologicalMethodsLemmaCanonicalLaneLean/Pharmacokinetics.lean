...
def PharmacokineticModelClosed (P : PharmacokineticModelPackage) : Prop :=
  P.absorptionRate ∧ P.distributionVolume ∧ P.eliminationRate ∧ P.bioavailability ∧ P.therapeuticWindow
...
theorem pharmacokinetic_model_closed_from_evidence (P : PharmacokineticModelPackage)
  ...
  exact And.intro E.absorptionRateClosed (And.intro E.distributionVolumeClosed
    (And.intro E.eliminationRateClosed (And.intro E.bioavailabilityClosed E.therapeuticWindowClosed)))
